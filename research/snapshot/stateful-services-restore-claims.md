...
live in `research/snapshot/checked-summaries/stateful-services/`.
...
```bash
node scripts/portable-machine-proof-matrix.mjs --preset stateful-services --check-summary-dir research/snapshot/checked-summaries/stateful-services --json
node scripts/portable-machine-proof-matrix.mjs --preset stateful-services-positive --check-summary-dir research/snapshot/checked-summaries/stateful-services --json
node scripts/portable-machine-proof-matrix.mjs --preset stateful-services-refusal --check-summary-dir research/snapshot/checked-summaries/stateful-services --json
```

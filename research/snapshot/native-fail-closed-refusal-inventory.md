...
| Raw cross-ISA whole-VM state                            | `cross-isa-vmstate-restore-unsupported`   | `../../docs/snapshot/vmstate-portability.md`, `portable-machine-snapshot.md`, `portable-machine-proof-profiles.md`                                                     | `vmstate-portability.test.ts`, `portable-machine-proof-runner.test.ts`                                                                                                                        |

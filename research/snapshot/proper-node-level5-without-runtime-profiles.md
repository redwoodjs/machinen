...
- Harness proof: `research/snapshot/node-level5-real-cross-arch-quickstart-fixture.md`
- Checked start summary: `research/snapshot/checked-summaries/node-level5/goal-023-proper-node-level5-track.json`

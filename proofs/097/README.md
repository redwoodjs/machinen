...
`pnpm exec tsx proofs/097/smoke.ts` proves the native parser accepts valid Zig capture records and refuses malformed records before target start.

## Validation

- [x] Run `pnpm exec tsx proofs/097/smoke.ts`.

...
`pnpm exec tsx proofs/063/smoke.ts` proves the provenance chain verifies and tampered or broken-link variants refuse.

## Validation

- [x] Run `pnpm exec tsx proofs/063/smoke.ts`.

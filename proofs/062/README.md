...
`pnpm exec tsx proofs/062/smoke.ts` proves live kernel-shaped evidence emits four resource descriptors and unsafe unread-byte state refuses.

## Validation

- [x] Run `pnpm exec tsx proofs/062/smoke.ts`.

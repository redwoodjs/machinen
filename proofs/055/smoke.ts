...
const nativeVerifier = join(repoRoot, "proofs/048/native-bundle-verifier.zig");
...
function main(): void {
  ...
  if (process.env.UPDATE_PROOF_055_SUMMARY === "1" || !existsSync(summaryPath)) {
    ...
    throw new Error(
      "proofs/055/checked-summary.json is stale; rerun with UPDATE_PROOF_055_SUMMARY=1",
    );
  }

# Proof 127 — Decode real string and array object records from captured bytes

## TL;DR

Decode real string and array object records from captured bytes.
...
`pnpm exec tsx proofs/by-id/127/smoke.ts` records the proof summary and boundary refusals.

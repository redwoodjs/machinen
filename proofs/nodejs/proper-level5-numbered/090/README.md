...
`pnpm exec tsx proofs/by-id/090/smoke.ts` proves the candidate subset is documented as not supported, no public CLI support is added, and docs do not advertise translated-continuation product support.

## Validation

- [x] Run `pnpm exec tsx proofs/by-id/090/smoke.ts`.

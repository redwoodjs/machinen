# Proof 140 — Native verifier emits signed/hashed continuation descriptor

## TL;DR

Native verifier emits signed/hashed continuation descriptor.
...
`pnpm exec tsx proofs/by-id/140/smoke.ts` records the proof summary and boundary refusals.

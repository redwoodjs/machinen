...
`pnpm exec tsx proofs/by-id/089/smoke.ts` proves five normalized runs produce one stable digest and six negative cases refuse before target start.

## Validation

- [x] Run `pnpm exec tsx proofs/by-id/089/smoke.ts`.

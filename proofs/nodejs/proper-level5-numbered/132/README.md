# Proof 132 — Timer handle reconstruction from real libuv timer fields

## TL;DR

Timer handle reconstruction from real libuv timer fields.
...
`pnpm exec tsx proofs/by-id/132/smoke.ts` records the proof summary and boundary refusals.

# Proof 128 — Decode real plain object properties from hidden-class/map evidence

## TL;DR

Decode real plain object properties from hidden-class/map evidence.
...
`pnpm exec tsx proofs/by-id/128/smoke.ts` records the proof summary and boundary refusals.

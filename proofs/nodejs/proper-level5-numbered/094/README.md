...
`pnpm exec tsx proofs/by-id/094/smoke.ts` proves repeated Proof 087 runs produce stable normalized results and documents the proof-local automation lane.

## Validation

- [x] Run `pnpm exec tsx proofs/by-id/094/smoke.ts`.

# Proof 126 — Native heap-region scanner finds object anchors in captured V8 mappings

## TL;DR

Native heap-region scanner finds object anchors in captured V8 mappings.
...
`pnpm exec tsx proofs/by-id/126/smoke.ts` records the proof summary and boundary refusals.

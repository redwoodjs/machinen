# Proof 152 — Real guarded restore command path behind feature flag

## TL;DR

Real guarded restore command path behind feature flag.
...
`pnpm exec tsx proofs/by-id/152/smoke.ts` records the proof summary and boundary refusals.

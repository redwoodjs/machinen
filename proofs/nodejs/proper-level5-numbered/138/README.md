# Proof 138 — Native verifier validates thread/fd/resource consistency

## TL;DR

Native verifier validates thread/fd/resource consistency.
...
`pnpm exec tsx proofs/by-id/138/smoke.ts` records the proof summary and boundary refusals.

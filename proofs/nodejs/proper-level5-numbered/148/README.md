# Proof 148 — Artifact diffing with stable normalized summaries

## TL;DR

Artifact diffing with stable normalized summaries.
...
`pnpm exec tsx proofs/by-id/148/smoke.ts` records the proof summary and boundary refusals.

# Proof 147 — amd64→arm64 real capture E2E repeated N times

## TL;DR

amd64→arm64 real capture E2E repeated N times.
...
`pnpm exec tsx proofs/by-id/147/smoke.ts` records the proof summary and boundary refusals.

# Proof 137 — Native verifier validates Node/V8/libuv build identity

## TL;DR

Native verifier validates Node/V8/libuv build identity.
...
`pnpm exec tsx proofs/by-id/137/smoke.ts` records the proof summary and boundary refusals.

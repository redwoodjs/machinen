# Proof 150 — CI-style lane documentation and gating policy

## TL;DR

CI-style lane documentation and gating policy.
...
`pnpm exec tsx proofs/by-id/150/smoke.ts` records the proof summary and boundary refusals.

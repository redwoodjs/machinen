...
`pnpm exec tsx proofs/by-id/061/smoke.ts` proves procfs-shaped files captured for a live process drive the classifier and unsafe thread evidence refuses before target start.

## Validation

- [x] Run `pnpm exec tsx proofs/by-id/061/smoke.ts`.

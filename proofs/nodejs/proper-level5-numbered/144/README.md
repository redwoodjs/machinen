# Proof 144 — Closure-heavy app with arrays/objects/strings

## TL;DR

Closure-heavy app with arrays/objects/strings.
...
`pnpm exec tsx proofs/by-id/144/smoke.ts` records the proof summary and boundary refusals.

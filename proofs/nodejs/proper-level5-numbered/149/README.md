# Proof 149 — Failure triage artifacts for every refusal class

## TL;DR

Failure triage artifacts for every refusal class.
...
`pnpm exec tsx proofs/by-id/149/smoke.ts` records the proof summary and boundary refusals.

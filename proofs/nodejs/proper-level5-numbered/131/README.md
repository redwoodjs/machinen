# Proof 131 — Native/libuv handle inventory from live Node process

## TL;DR

Native/libuv handle inventory from live Node process.
...
`pnpm exec tsx proofs/by-id/131/smoke.ts` records the proof summary and boundary refusals.

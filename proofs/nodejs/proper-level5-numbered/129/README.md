# Proof 129 — Decode closure contexts from captured V8 context slots

## TL;DR

Decode closure contexts from captured V8 context slots.
...
`pnpm exec tsx proofs/by-id/129/smoke.ts` records the proof summary and boundary refusals.

# Proof 154 — Docs/support matrix for exact supported subset

## TL;DR

Docs/support matrix for exact supported subset.
...
`pnpm exec tsx proofs/by-id/154/smoke.ts` records the proof summary and boundary refusals.

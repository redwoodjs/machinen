# Proof 153 — Stable public refusal error registry

## TL;DR

Stable public refusal error registry.
...
`pnpm exec tsx proofs/by-id/153/smoke.ts` records the proof summary and boundary refusals.

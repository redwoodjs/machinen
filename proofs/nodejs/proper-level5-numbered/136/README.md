# Proof 136 — Native verifier parses real process/maps/fd/thread/resource bundle

## TL;DR

Native verifier parses real process/maps/fd/thread/resource bundle.
...
`pnpm exec tsx proofs/by-id/136/smoke.ts` records the proof summary and boundary refusals.

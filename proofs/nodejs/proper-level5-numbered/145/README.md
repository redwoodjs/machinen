# Proof 145 — Negative real-app suite for active/unsupported state

## TL;DR

Negative real-app suite for active/unsupported state.
...
`pnpm exec tsx proofs/by-id/145/smoke.ts` records the proof summary and boundary refusals.

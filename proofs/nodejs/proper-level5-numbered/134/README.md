# Proof 134 — Pipe/file/stdio reconstruction from real fd + libuv records

## TL;DR

Pipe/file/stdio reconstruction from real fd + libuv records.
...
`pnpm exec tsx proofs/by-id/134/smoke.ts` records the proof summary and boundary refusals.

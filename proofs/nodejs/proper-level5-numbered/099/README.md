...
`pnpm exec tsx proofs/by-id/099/smoke.ts` proves native decoding emits graph IR for the supported record and refuses unsupported build, encoding, and map variants.

## Validation

- [x] Run `pnpm exec tsx proofs/by-id/099/smoke.ts`.

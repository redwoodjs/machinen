# Proof 139 — Native verifier validates heap graph references and resource links

## TL;DR

Native verifier validates heap graph references and resource links.
...
`pnpm exec tsx proofs/by-id/139/smoke.ts` records the proof summary and boundary refusals.

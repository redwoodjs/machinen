# Proof 151 — Real guarded capture command path behind feature flag

## TL;DR

Real guarded capture command path behind feature flag.
...
`pnpm exec tsx proofs/by-id/151/smoke.ts` records the proof summary and boundary refusals.

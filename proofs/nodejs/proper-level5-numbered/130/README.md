# Proof 130 — Build one graph IR from actual captured V8 heap slices

## TL;DR

Build one graph IR from actual captured V8 heap slices.
...
`pnpm exec tsx proofs/by-id/130/smoke.ts` records the proof summary and boundary refusals.

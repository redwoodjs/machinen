# Proof 143 — TCP listener + pipe/stdio app

## TL;DR

TCP listener + pipe/stdio app.
...
`pnpm exec tsx proofs/by-id/143/smoke.ts` records the proof summary and boundary refusals.

...
`pnpm exec tsx proofs/by-id/104/smoke.ts` proves the CLI boundary accepts Proof 100 evidence only under explicit proof flags and refuses unsafe/product-claim variants.

## Validation

- [x] Run `pnpm exec tsx proofs/by-id/104/smoke.ts`.

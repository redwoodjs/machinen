# Proof 146 — arm64→amd64 real capture E2E repeated N times

## TL;DR

arm64→amd64 real capture E2E repeated N times.
...
`pnpm exec tsx proofs/by-id/146/smoke.ts` records the proof summary and boundary refusals.

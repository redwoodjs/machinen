...
`pnpm exec tsx proofs/088/smoke.ts` proves native assembly and native verification run over real artifact files and refuse invalid inputs before target start.

## Validation

- [x] Run `pnpm exec tsx proofs/088/smoke.ts`.

...
`pnpm exec tsx proofs/102/smoke.ts` proves the real-capture negative gauntlet refuses all invalid rows before target start.

## Validation

- [x] Run `pnpm exec tsx proofs/102/smoke.ts`.

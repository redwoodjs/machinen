...
AMD64_HOST=${REAL_MORE_AMD64_HOST:-root@192.168.0.8}
ARM64_HOST=${REAL_MORE_ARM64_HOST:-friend@100.126.46.90}
RUN_ID=${REAL_MORE_RUN_ID:-$(date -u +%Y%m%dT%H%M%SZ)-$$}
AMD64_BASE=${REAL_MORE_AMD64_REMOTE_BASE:-/mnt/shared-500G}
ARM64_BASE=${REAL_MORE_ARM64_REMOTE_BASE:-/tmp}
AMD64_WORK=${REAL_MORE_AMD64_WORK:-$AMD64_BASE/machinen-real-more-cross-arch-amd64-$RUN_ID}
ARM64_WORK=${REAL_MORE_ARM64_WORK:-$ARM64_BASE/machinen-real-more-cross-arch-arm64-$RUN_ID}
SCRIPT=real_more_unmodified_cross_arch_continuation.py
...
echo "Real more unmodified cross-arch experiment completed"

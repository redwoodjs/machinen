...
AMD64_HOST=${REAL_PIPELINE_LADDER_AMD64_HOST:-root@192.168.0.8}
ARM64_HOST=${REAL_PIPELINE_LADDER_ARM64_HOST:-friend@100.126.46.90}
RUN_ID=${REAL_PIPELINE_LADDER_RUN_ID:-$(date -u +%Y%m%dT%H%M%SZ)-$$}
AMD64_BASE=${REAL_PIPELINE_LADDER_AMD64_REMOTE_BASE:-/mnt/shared-500G}
ARM64_BASE=${REAL_PIPELINE_LADDER_ARM64_REMOTE_BASE:-/tmp}
AMD64_WORK=${REAL_PIPELINE_LADDER_AMD64_WORK:-$AMD64_BASE/machinen-real-pipeline-supervisor-ladder-amd64-$RUN_ID}
ARM64_WORK=${REAL_PIPELINE_LADDER_ARM64_WORK:-$ARM64_BASE/machinen-real-pipeline-supervisor-ladder-arm64-$RUN_ID}
SCRIPT=real_pipeline_and_supervisor_ladder.py
...
echo "Real pipeline/supervisor ladder completed"

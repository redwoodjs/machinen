...
AMD64_HOST=${REAL_SOCKET_LADDER_AMD64_HOST:-root@192.168.0.8}
ARM64_HOST=${REAL_SOCKET_LADDER_ARM64_HOST:-friend@100.126.46.90}
RUN_ID=${REAL_SOCKET_LADDER_RUN_ID:-$(date -u +%Y%m%dT%H%M%SZ)-$$}
AMD64_BASE=${REAL_SOCKET_LADDER_AMD64_REMOTE_BASE:-/mnt/shared-500G}
ARM64_BASE=${REAL_SOCKET_LADDER_ARM64_REMOTE_BASE:-/tmp}
AMD64_WORK=${REAL_SOCKET_LADDER_AMD64_WORK:-$AMD64_BASE/machinen-real-socket-ladder-amd64-$RUN_ID}
ARM64_WORK=${REAL_SOCKET_LADDER_ARM64_WORK:-$ARM64_BASE/machinen-real-socket-ladder-arm64-$RUN_ID}
SCRIPT=real_socket_resource_ladder.py
...
echo "Real socket resource ladder completed"

...
const rowId = "034-memory-typed-array";
const refused = false;
const semanticIr = {
  kind: "typed-array",
  type: "Uint32Array",
...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-typed-array-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Selected typed array contents materialized target-native"],
    notClaimed: [

...
const rowId = "026-memory-string";
const refused = false;
const semanticIr = {
  kind: "string",
  value: "machinen-memory-string",
};
const claimGuard = {
...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-string-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Selected V8 string state decoded into semantic IR and materialized target-native"],
    notClaimed: [

...
const rowId = "032-memory-http-handler-closure-state";
const refused = false;
const semanticIr = {
  kind: "closure-http-handler",
  value: {
    count: 41,
    afterRequest: 42,
  },
...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-http-handler-closure-state-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Selected HTTP handler closure state materialized target-native"],
    notClaimed: [

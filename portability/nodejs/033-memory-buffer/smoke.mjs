...
const rowId = "033-memory-buffer";
const refused = false;
const semanticIr = {
  kind: "buffer",
  value: "6d616368696e656e",
};
const claimGuard = {
...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-buffer-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Selected internal Buffer bytes materialized target-native"],
    notClaimed: [

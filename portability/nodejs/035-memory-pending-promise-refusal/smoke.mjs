...
const rowId = "035-memory-pending-promise-refusal";
const refused = true;
const semanticIr = {
  kind: "pending-promise",
  reason: "pending Promise/microtask continuation is active runtime state",
};
const claimGuard = {
...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-pending-promise-refusal-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Pending Promise and microtask state refuses fail-closed"],
    notClaimed: [

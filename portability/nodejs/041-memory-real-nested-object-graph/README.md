# 041-memory-real-nested-object-graph — nested-object-graph

Selected nested object graph captured from source process memory and materialized target-native across architectures.

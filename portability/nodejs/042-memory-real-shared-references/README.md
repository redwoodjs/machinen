# 042-memory-real-shared-references — shared-references

Selected shared-reference graph captured from source process memory and materialized target-native across architectures.

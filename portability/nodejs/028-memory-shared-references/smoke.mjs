...
const rowId = "028-memory-shared-references";
const refused = false;
const semanticIr = {
  kind: "graph",
  value: {
...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-shared-references-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Selected object graph shared references preserved semantically"],
    notClaimed: [

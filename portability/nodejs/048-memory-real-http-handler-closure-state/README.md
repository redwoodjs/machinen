# 048-memory-real-http-handler-closure-state — http-handler-closure-state

Selected HTTP handler closure state captured from source process memory and materialized target-native across architectures.

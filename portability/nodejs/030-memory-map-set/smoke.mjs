...
const rowId = "030-memory-map-set";
const refused = false;
const semanticIr = {
  kind: "collections",
  value: {
...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-map-set-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Selected Map and Set entries materialized target-native"],
    notClaimed: [

...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-cycle-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Selected cyclic object graph preserved semantically"],
    notClaimed: [

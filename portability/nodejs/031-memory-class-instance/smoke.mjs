...
const rowId = "031-memory-class-instance";
const refused = false;
const semanticIr = {
  kind: "class-instance",
  className: "Counter",
...
const out = resolve(
  outFlag === -1
    ? "portability/nodejs/retained/nodejs-portability-memory-class-instance-report.json"
...
const report = {
  ...
  claimBoundary: {
    claims: ["Selected class instance data and prototype identity materialized target-native"],
    notClaimed: [

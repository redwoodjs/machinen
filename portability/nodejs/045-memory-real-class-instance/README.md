# 045-memory-real-class-instance — class-instance

Selected class instance state captured from source process memory and materialized target-native across architectures.

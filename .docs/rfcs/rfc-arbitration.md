...
1. **Decision log format:** Draft A's explicit decision table should be adopted in Draft B's RFC revision. Clearly document _why_ exponential backoff was chosen over hard exit, and _why_ `src/sync.mjs` was not refactored.

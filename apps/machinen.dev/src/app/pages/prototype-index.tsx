  ...
  <div className="min-h-screen bg-[#F4F4FB] text-[#0E0E47] font-sans antialiased grid place-items-center px-6">
    <div className="max-w-2xl w-full">
      ...
      <p className="text-[16px] text-[#3A3A6B] mb-10 max-w-[520px]">
        Two prototypes built from the same Notion-inspired patterns — bracketed nav, code paired
        with a terminal-output banner, dotted-line diagrams, pixel-tile agents. Same content,
        opposite palettes.
      </p>

    ...
    <nav className="border-b border-[#E1E1F0] bg-[#F4F4FB]/80 backdrop-blur-sm sticky top-0 z-10">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2 text-[#0E0E47] font-semibold tracking-tight">
          <span className="inline-block w-7 h-7 rounded-sm bg-[#2026A0] text-white grid place-items-center text-sm font-bold">
            M
          </span>
          machinen
        </a>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="text-[15px] text-[#0E0E47] hover:text-[#2026A0]"
          >
            GitHub
          </a>
          <a
            href="https://github.com/redwoodjs/machinen"
            className="bg-[#2026A0] hover:bg-[#181D80] text-white text-[15px] font-medium px-4 py-2 rounded"
          >
            Get started
          </a>
        </div>
  ...
  return (
    <div className="rounded-md border border-[#D5D5EC] bg-white overflow-hidden shadow-[0_1px_0_rgba(14,14,71,0.04)]">
      <div className="flex items-center justify-between px-5 py-3 border-b border-[#E8E8F2]">
        ...
        <a
          href="https://github.com/redwoodjs/machinen"
          className="flex items-center gap-1.5 text-[13px] text-[#5C5C8C] hover:text-[#2026A0]"
        >
  ...
  return (
    <div className="rounded-md border border-[#D5D5EC] bg-white shadow-[0_8px_24px_-12px_rgba(32,38,160,0.25)] w-[340px]">
      <div className="px-5 py-4 border-b border-[#E8E8F2] flex items-center gap-2">
        <span className="w-5 h-5 rounded-sm bg-[#E5E5F7] grid place-items-center text-[#2026A0] font-mono text-[11px] font-bold">
          VM
        </span>
...
function Row({
  ...
  return (
    <div className="grid grid-cols-[100px_1fr] gap-2 px-5 py-2.5 border-b border-[#F0F0F8] last:border-b-0 items-center">
      ...
      {tag ? (
        <span className="inline-flex bg-[#E5E5F7] text-[#2026A0] px-2 py-0.5 rounded-sm w-fit text-[12px] font-medium">
          {value}
        </span>
      ) : (
...
function H2({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-[40px] leading-[1.1] tracking-tight font-semibold text-[#0E0E47] mb-5">
      {children}
    </h2>
  );
}
  ...
  <div className="bg-[#F4F4FB] text-[#0E0E47] min-h-screen font-sans antialiased">
    ...
    <section className="max-w-6xl mx-auto px-6 pt-20 pb-16">
      ...
      <h1 className="text-[64px] leading-[1.02] tracking-[-0.02em] font-semibold max-w-[860px] mb-6">
        Hand off a running coding agent.{" "}
        <span className="text-[#2026A0]">Between your machines.</span>
      </h1>
      <p className="text-[19px] leading-[1.55] text-[#3A3A6B] max-w-[680px] mb-8">
        Between your laptop and your desktop. Between your laptop and Machinen Cloud. The whole VM
        moves — every process, every byte of memory, every open file, every timer. The agent never
        restarts.
      </p>
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <a
          href="https://github.com/redwoodjs/machinen"
          className="bg-[#2026A0] hover:bg-[#181D80] text-white text-[15px] font-medium px-5 py-3 rounded"
        >
          Read the docs →
        </a>
    ...
    <section id="round-trip" className="max-w-6xl mx-auto px-6 py-20 border-t border-[#E1E1F0]">
      ...
      <Lede>
        Your agent is building a feature on your laptop — but you've got to step out. You close your
        lid and everything pauses: the running test, the open file handles, the half-written diff.
        Ship the frozen VM to your desktop. Thaw it, and the agent resumes exactly where it stopped.
      </Lede>
      <div className="mt-10">
        <HandoffAnimation />
      </div>
    ...
    <section id="walkthrough" className="max-w-6xl mx-auto px-6 py-20 border-t border-[#E1E1F0]">
      ...
      <Lede>
        Bake the VM. Boot it. Drive it from your Node process. Snapshot, restore. Same primitives in
        TypeScript or at the shell.
      </Lede>
    ...
    <section id="fork" className="max-w-6xl mx-auto px-6 py-20 border-t border-[#E1E1F0]">
      ...
      <H2>
        Snapshot. Restore. <span className="text-[#2026A0]">Fork.</span>
      </H2>
      <Lede>Three motions fall out of being able to freeze and thaw a running VM.</Lede>

      <div className="grid md:grid-cols-3 gap-6 mt-10">
        {[
          {
            name: "Snapshot",
            body: "Write the running state to disk. Memory, file descriptors, timers, all of it. The bundle is a directory you can ship anywhere.",
          },
          {
            name: "Restore",
            body: "Thaw a snapshot on another host. The agent comes up exactly where it left off.",
          },
          {
            name: "Fork",
            body: "Snapshot and restore at the same time, without killing the source. Children inherit the same heap and diverge from there.",
          },
        ].map((c) => (
          <div key={c.name} className="bg-white border border-[#D5D5EC] rounded-md p-6">
            <div className="font-mono text-[12px] text-[#2026A0] uppercase tracking-wider mb-2">
              {c.name}
            </div>
    ...
    <section id="agents" className="max-w-6xl mx-auto px-6 py-20 border-t border-[#E1E1F0]">
      ...
      <Lede>
        Machinen is the runtime. Anything that runs in a Linux process runs in a Machinen VM — and
        can be snapshotted, forked, or moved.
      </Lede>
    ...
    <section id="compat" className="max-w-6xl mx-auto px-6 py-20 border-t border-[#E1E1F0]">
      ...
      <Lede>
        Machinen runs real Linux microVMs — that's what makes snapshot and restore possible in the
        first place. You build the VM in TypeScript: install packages, write files, set the command.
      ...
      <div className="mt-8 grid md:grid-cols-3 gap-4 text-[14px]">
        {["Apple Silicon Macs", "Bare-metal arm64 Linux", "Graviton .metal"].map((p) => (
          <div
            key={p}
            className="border border-dashed border-[#A8A8D0] rounded-md px-4 py-3 font-mono text-[#0E0E47]"
          >
            {p}
          </div>
        ))}
    ...
    <footer className="max-w-6xl mx-auto px-6 py-16 border-t border-[#E1E1F0]">
      <div className="bg-white border border-[#D5D5EC] rounded-md p-6">
        ...
        <p className="text-[15px] text-[#3A3A6B] leading-[1.55]">
          ...
          <a
            href="https://github.com/redwoodjs/machinen"
            className="text-[#2026A0] hover:underline"
          >

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3acb0c1b728da44529c5ba3453d62b6c)
// Runtime types generated with workerd@1.20250617.0 2025-06-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WEBAUTHN_RP_ID: string;
		AUTH_SECRET_KEY: string;
		CONTAINER: DurableObjectNamespace<import("./src/worker").Container>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBAUTHN_RP_ID" | "AUTH_SECRET_KEY">> {}
}

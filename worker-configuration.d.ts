/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 22bc1a04e43ef0bbe80169af5d95e294)
// Runtime types generated with workerd@1.20250617.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WEBAUTHN_RP_ID: string;
		AUTH_SECRET_KEY: string;
		RUNTIME_CONTAINER: DurableObjectNamespace<import("./src/worker").RuntimeContainer>;
		ASSETS: Fetcher;
	}
}

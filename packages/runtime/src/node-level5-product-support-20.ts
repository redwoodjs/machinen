...
export const nodeLevel5ProductSupport20Families: readonly NodeLevel5ProductSupportFamily[] = [
  productFamily({
    ...
    contractArtifact: "proofs/227/checked-summary.json",
    e2eArtifact: "proofs/228/checked-summary.json",
  }),
  productFamily({
    id: "timer-service",
    title: "Timer service",
    ...
    contractArtifact: "proofs/229/checked-summary.json",
    e2eArtifact: "proofs/230/checked-summary.json",
  }),
  productFamily({
    id: "plain-js-heap",
    ...
    contractArtifact: "proofs/231/checked-summary.json",
    e2eArtifact: "proofs/232/checked-summary.json",
  }),
  productFamily({
    ...
    contractArtifact: "proofs/233/checked-summary.json",
    e2eArtifact: "proofs/234/checked-summary.json",
  }),
  productFamily({
    ...
    contractArtifact: "proofs/235/checked-summary.json",
    e2eArtifact: "proofs/236/checked-summary.json",
  }),
];

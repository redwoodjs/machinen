...
export const nodeLevel5ProductSupport20Families: readonly NodeLevel5ProductSupportFamily[] = [
  productFamily({
    ...
    contractArtifact: "proofs/by-id/227/checked-summary.json",
    e2eArtifact: "proofs/by-id/228/checked-summary.json",
  }),
  productFamily({
    id: "timer-service",
    title: "Timer service",
    ...
    contractArtifact: "proofs/by-id/229/checked-summary.json",
    e2eArtifact: "proofs/by-id/230/checked-summary.json",
  }),
  productFamily({
    id: "plain-js-heap",
    ...
    contractArtifact: "proofs/by-id/231/checked-summary.json",
    e2eArtifact: "proofs/by-id/232/checked-summary.json",
  }),
  productFamily({
    ...
    contractArtifact: "proofs/by-id/233/checked-summary.json",
    e2eArtifact: "proofs/by-id/234/checked-summary.json",
  }),
  productFamily({
    ...
    contractArtifact: "proofs/by-id/235/checked-summary.json",
    e2eArtifact: "proofs/by-id/236/checked-summary.json",
  }),
];

...
export const ErrorCode = {
  ...
  BOOT_MODULES_NOT_FOUND: "BOOT_MODULES_NOT_FOUND",
  ...
  MKINITRAMFS_MODULES_NOT_FOUND: "MKINITRAMFS_MODULES_NOT_FOUND",
  MKINITRAMFS_MODULES_EXTRACT_FAILED: "MKINITRAMFS_MODULES_EXTRACT_FAILED",

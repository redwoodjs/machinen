...
export const ErrorCode = {
  ...
  BOOT_DETACHED_INCOMPATIBLE: "BOOT_DETACHED_INCOMPATIBLE",
  ...
  SNAPSHOT_LIVE_MOUNT_ACTIVE: "SNAPSHOT_LIVE_MOUNT_ACTIVE",
  // host-side CRIU page-server (#266 step 2)
  PAGE_SERVER_BINARY_MISSING: "PAGE_SERVER_BINARY_MISSING",
  PAGE_SERVER_FAILED: "PAGE_SERVER_FAILED",

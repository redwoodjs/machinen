...
export const ErrorCode = {
  ...
  BOOT_STDIO_INVALID: "BOOT_STDIO_INVALID",
  BOOT_STDIO_DETACHED: "BOOT_STDIO_DETACHED",
  BOOT_DETACHED_READINESS_FAILED: "BOOT_DETACHED_READINESS_FAILED",
  BOOT_MEMORY_INVALID: "BOOT_MEMORY_INVALID",
  BOOT_CPU_INVALID: "BOOT_CPU_INVALID",
  BOOT_CPU_UNSUPPORTED: "BOOT_CPU_UNSUPPORTED",
  BOOT_NESTED_VIRT_UNSUPPORTED: "BOOT_NESTED_VIRT_UNSUPPORTED",
  BOOT_VMSTATE_UNSUPPORTED: "BOOT_VMSTATE_UNSUPPORTED",
  BOOT_VMSTATE_CROSS_ISA_UNSUPPORTED: "BOOT_VMSTATE_CROSS_ISA_UNSUPPORTED",
  ...
  SNAPSHOT_PORTABLE_REFUSED: "SNAPSHOT_PORTABLE_REFUSED",
  ...
  MKINITRAMFS_INPUT_NOT_FOUND: "MKINITRAMFS_INPUT_NOT_FOUND",
  MKINITRAMFS_INPUT_INVALID: "MKINITRAMFS_INPUT_INVALID",
  MKINITRAMFS_FAILED: "MKINITRAMFS_FAILED",

...
export const nodeLevel5ProductSupport80NewFamilies: readonly NodeLevel5ProductSupport80Family[] = [
  productFamily80({
    ...
    contractArtifact: "proofs/296/checked-summary.json",
    e2eArtifact: "proofs/296/checked-summary.json",
  }),
  productFamily80({
    ...
    contractArtifact: "proofs/297/checked-summary.json",
    e2eArtifact: "proofs/297/checked-summary.json",
  }),
  productFamily80({
    ...
    contractArtifact: "proofs/298/checked-summary.json",
    e2eArtifact: "proofs/298/checked-summary.json",
  }),
];
...
function evidenceFor(
  ...
  return directions.map((direction) => ({
    ...
    direction,
    substrate: "machinen-real-vm-cross-arch",
    artifactBundle: `proofs/291/artifacts/${familyId}/${direction}`,
    manifestVerified: true,
    captureSummaryVerified: true,
    restoreSummaryVerified: true,
    targetLogsVerified: true,

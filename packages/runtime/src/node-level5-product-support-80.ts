...
export const nodeLevel5ProductSupport80NewFamilies: readonly NodeLevel5ProductSupport80Family[] = [
  productFamily80({
    ...
    contractArtifact: "proof/296/checked-summary.json",
    e2eArtifact: "proof/296/checked-summary.json",
  }),
  productFamily80({
    ...
    contractArtifact: "proof/297/checked-summary.json",
    e2eArtifact: "proof/297/checked-summary.json",
  }),
  productFamily80({
    ...
    contractArtifact: "proof/298/checked-summary.json",
    e2eArtifact: "proof/298/checked-summary.json",
  }),
];
...
function evidenceFor(
  ...
  return directions.map((direction) => ({
    ...
    direction,
    substrate: "machinen-real-vm-cross-arch",
    artifactBundle: `proof/291/artifacts/${familyId}/${direction}`,
    manifestVerified: true,
    captureSummaryVerified: true,
    restoreSummaryVerified: true,
    targetLogsVerified: true,

...
pub fn main(init: std.process.Init) !u8 {
    ...
    if (std.mem.eql(u8, command, "--help") or std.mem.eql(u8, command, "-h") or std.mem.eql(u8, command, "help")) {
        try protocol.stdout(g_io, "{\"ok\":true,\"protocolVersion\":1,\"commands\":[\"mkinitramfs\",\"mountdisk-image\",\"mountdisk-upper\",\"rootfs-cache-key\",\"rootfs-materialize\",\"tree-manifest-hash\"]}\n");

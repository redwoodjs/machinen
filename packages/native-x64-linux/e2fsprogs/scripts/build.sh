#!/usr/bin/env bash
# Build a static mke2fs for x64 linux and drop it at bin/mke2fs.
#
# Why: Linux installs vary in path/version. Bundling a known-good static
# binary lets the runtime materialize ext4 rootfs images without a host
# install.

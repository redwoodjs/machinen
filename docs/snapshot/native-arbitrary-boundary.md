...
native final jump, a captured-process native final jump, and first real utility
attempts. It still does not claim generic final instruction-pointer jump for
arbitrary optimized binaries.

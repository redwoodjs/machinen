...
5. returns to the bounded trampoline sentinel.
...
Returning from this synthetic syscall is still not a full process migration; a
later gate owns target process exit.

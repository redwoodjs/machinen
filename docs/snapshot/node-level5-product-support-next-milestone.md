...
7. Run `machinen node-level5 85-readiness --generic-vm-corpus-report <file> --json`; it must show candidate evidence accepted and only the final `claim-change-unlocked` gate blocked before the claim PR.

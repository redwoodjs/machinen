...
| GIC system regs         | `ICC_*`                                                                                                                                                                             | tracked separately (#22)                                                                              | GIC state has its own section in `.snaplet`; the per-CPU sysreg interface to GICv3 is captured under `gic_redist`.                                                                                              |

...
- [portable VM guest inventory contract](./snapshot/portable-vm-guest-inventory-contract.json) — fixture guest inventory input shape consumed before VM Portability Plan classification

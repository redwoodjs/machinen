...
- [controlled C translated continuation](./snapshot/architecture-portable-controlled-continuation.md) — first target-native opposite-ISA continuation bundle proof

# Cross-architecture CRIU-like restore goals

This directory tracks the progressive path from safe semantic restore toward a
CRIU-like cross-architecture restore experience.
...
| ---------------------------------------------------------- | ----------------------------------------------------- | ------------------------------------------------ | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| [`001`](./001.md)                                          | Cross-architecture CRIU-like seamless restore roadmap | Roadmap                                          | Roadmap                       | Define the product ladder and state vocabulary for CRIU-like restore.                                                         | Support ladder, state vocabulary, ping teaching case, milestones.                                                                |
...
| [`004`](./004-guest-criu-substrate.md)                     | CRIU inside the guest substrate proof                 | 3. CRIU inside the VM                            | Same-guest CRIU substrate     | Prove the guest Linux surface supports in-guest CRIU for ordinary workloads, or refuses clearly.                              | `criu check`, C checkpoint/restore, JVM checkpoint/restore-or-refusal, CRIU version/log summaries.                               |
| [`005`](./005-portable-snapshot-guest-criu-composition.md) | Portable snapshot plus guest CRIU composition proof   | 4. Portable snapshot plus guest CRIU composition | Composition                   | Prove Machinen snapshot/restore and in-guest CRIU do not break each other.                                                    | Guest CRIU before/after Machinen restore, stored CRIU image readability, no cross-ISA CRIU replay claim.                         |
...
3. [`004`](./004-guest-criu-substrate.md) — prove same-guest CRIU substrate.
4. [`005`](./005-portable-snapshot-guest-criu-composition.md) — prove Machinen and
   guest CRIU layers compose.
